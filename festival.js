...
const initCheckpoints = () => {
    const areas = {
        ...
        area2: {width: 81, height: 51, amount: 140, position: { x: 0, y: 0, z: -50 }},
        area3: {width: 81, height: 51, amount: 160, position: { x: 0, y: 0, z: -100 }},
        area4: {width: 81, height: 51, amount: 140, position: { x: -85, y: 0, z: -47 }},
